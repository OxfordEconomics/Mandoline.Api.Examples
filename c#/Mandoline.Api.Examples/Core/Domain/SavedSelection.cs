...
public class SavedSelection
{
    ...
    public static async Task RunCreateSavedSelection(Output output)
    {
        ...
        Client.Models.Assertion<SelectionDto> selectionResult = await api.CreateSavedSelectionAsync(
            sampleSelect,
    ...
    public static async Task RunUpdateSavedSelection(Output output)
    {
        ...
        Client.Models.Assertion<Client.Models.Selection> oldSelect = await api.GetSavedSelection(AppConstants.SavedSelectionId).ConfigureAwait(true);
        ...
        // run update
        Client.Models.Assertion<SelectionDto> updateResult = await api.UpdateSavedSelectionAsync(
    ...
    public static async Task RunGetSavedSelection(Guid s_id, Output output)
    {
        ...
        // run get
        Client.Models.Assertion<Client.Models.Selection> getResult = await api.GetSavedSelection(s_id).ConfigureAwait(true);
