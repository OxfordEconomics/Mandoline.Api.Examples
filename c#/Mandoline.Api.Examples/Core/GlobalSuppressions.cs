...
[assembly: SuppressMessage("StyleCop.CSharp.OrderingRules", "SA1201:Elements should appear in the correct order", Justification = "<Pending>", Scope = "member", Target = "~M:Core.Client.ServiceModels.SelectionDto.#ctor")]

[assembly: SuppressMessage("Design", "CA1068:CancellationToken parameters must come last", Justification = "<Pending>", Scope = "member", Target = "~M:Core.ApiClient.PerformPost``1(System.Object,System.String,System.Threading.CancellationToken,System.Boolean)~System.Threading.Tasks.Task{Core.Client.Models.Assertion{``0}}")]

[assembly: SuppressMessage("StyleCop.CSharp.NamingRules", "SA1309:Field names should not begin with underscore", Justification = "<Pending>", Scope = "member", Target = "~F:Core.ApiClient._clientName")]
